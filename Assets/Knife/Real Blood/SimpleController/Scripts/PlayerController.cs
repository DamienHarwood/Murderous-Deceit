...
namespace Knife.RealBlood.SimpleController
{
    ...
    {
        private EnemyNavigation[] enemyRef;
        ...
        void Start()
        {
            if (FindObjectOfType<EnemyNavigation>() != null)
            {
                enemyRef = FindObjectsOfType<EnemyNavigation>();
            }
        ...
        void Update()
        {
            if (enemyRef == null && FindObjectOfType<EnemyNavigation>() != null)
            {
                enemyRef = FindObjectsOfType<EnemyNavigation>();
            }
        ...
        void move()
        {
            ...
            if (enemyRef != null)
            {
                ...
                {
                    enemyRef[i].enemySpeed = playerVelocity.x + playerVelocity.z;
                }
            }
            /////ADDED CODE/////
